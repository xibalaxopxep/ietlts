...
@section('content')
<div class="content">
    <form action="{!!route('admin.online_course.update',$record->id)!!}" method="POST" enctype="multipart/form-data">
        <div class="card">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            <a type="button" href="{{route('admin.online_course.index')}}" class="btn btn-secondary legitRipple">Hủy</a>
