...
<div class="content">
    ...
    <div class="card">
       ...
       <form action="{!!route('admin.news.update_multiple')!!}" method="POST" enctype="multipart/form-data">
            @csrf  
     <div class="card-body">
         <div class="row " style="">
        ...
        <table class="table datatable-basic">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$record->title}}<br><img style="max-height: 100px; max-width:  150px;" src="{{asset($record->images)}}"></td>
                    ...
                    <td class="">
                        <a href="{{route('admin.news.edit', $record->id)}}" title="{!! trans('base.edit') !!}" class="success"><i class="icon-pencil"></i></a>
