...
@section('content')
<div class="content">
    <form action="{!!route('admin.contact_address.update',$record->id)!!}" method="POST" enctype="multipart/form-data">
        <div class="card">
                            ...
                            <div class="col-md-10" style="">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="phone_1" value="{!!$record->phone_1!!}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="phone_2" value="{!!$record->phone_2!!}" >
