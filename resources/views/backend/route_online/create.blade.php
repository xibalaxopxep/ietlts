...
@section('content')
<div class="content">
    <form action="{!!route('admin.route_online.store')!!}" method="POST" enctype="multipart/form-data">
        <div class="card">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="left-icon-tab1">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="col-md-2 col-form-label text-right">Lộ trình học dành cho ai </label>
                                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            <a type="button" href="{{route('admin.route_online.index')}}" class="btn btn-secondary legitRipple">Hủy</a>
