...
class ProductController extends Controller {
    ...
    public function index(Request $request) {
        ...
        $records = $this->productRepo->readFE($request, $limit = 18);
...
//        $product_arr = $this->productCategoryRepo->getCategory($record->categories);
        ...
        if (config('global.device') !== 'pc') {
            return view('mobile/product/detail', compact('record', 'gallery', 'image_arr', 'attribute_arr', 'related_product', 'url', 'viewed_products'));
        } else {
            return view('frontend/product/detail', compact('record', 'gallery', 'image_arr', 'attribute_arr', 'related_product', 'url', 'viewed_products'));
        }
    }
