...
<div class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
         ...
         <form action="{!!route('admin.video.update_multiple')!!}" method="POST" enctype="multipart/form-data">
            @csrf  
         <div class="card-body">
         <div class="row " style="">
            ...
            <div class="col-md-7">
             <select class="form-control select-search filter_video" >
                    @if(0 == $cat_id)
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="">
                        ...
                        <a href="{{route('admin.video.edit', $record->id)}}" title="{!! trans('base.edit') !!}" class="success"><i class="icon-pencil"></i></a>
                       <!--  <form action="{!! route('admin.video.destroy', ['id' => $record->id]) !!}" method="POST" style="display: inline-block">
                            {!! method_field('DELETE') !!}
                            {!! csrf_field() !!}
...
<script type="text/javascript">
  ...
  $(':checkbox').prop('checked', c);
    ...
    $('.filter_video').on('change',function(){
