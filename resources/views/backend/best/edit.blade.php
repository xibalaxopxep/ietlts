...
@section('content')
<div class="content">
    <form action="{!!route('admin.best.update',$record->id)!!}" method="POST" enctype="multipart/form-data">
        <div class="card">
                                  ...
                                  <div class="form-group row">
                                    <div class="form-check col-md-4 form-check-right">
                                        <label class="form-check-label float-right">
                                            ...
                                            @if($record->is_best == 1)
                                            <input checked="" type="checkbox" class="form-check-input-styled" name="is_best" data-fouc="">
                                            @else
