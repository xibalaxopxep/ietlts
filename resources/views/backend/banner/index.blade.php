        ...
        <table class="table datatable-basic">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$record->name}}</td>
                    <td><img src="{{$record->image}}" style="height: 100px; width: 170px"></td>
                    ...
                    <td class="">
                        <a href="{{route('admin.banner.edit',$record->id)}}" title="{!! trans('base.edit') !!}" class="success"><i class="icon-pencil"></i></a>
                        <form action="{!! route('admin.banner.destroy',$record->id) !!}" method="POST" style="display: inline-block">
                            {!! method_field('DELETE') !!}
                            {!! csrf_field() !!}
