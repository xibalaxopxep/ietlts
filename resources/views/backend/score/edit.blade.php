...
@section('content')
<div class="content">
    <form action="{!!route('admin.score.update',$record->id)!!}" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                                    ...
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                  <input type="text" min="1" class="form-control" value="{{$record->score}}" name="score">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="form-check col-md-5 form-check-right">
                                                    <label class="form-check-label float-right">
                                                        Kích hoạt
                                                        @if($record->status == 1)
                                                        <input type="checkbox" checked="" class="form-check-input-styled" name="status" value="1" data-fouc="">
                                                        @else
