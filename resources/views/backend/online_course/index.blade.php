...
<div class="content">
    ...
    <div class="card">
       ...
       <form action="{!!route('admin.online_course.update_multiple')!!}" method="POST" enctype="multipart/form-data">
            @csrf  
             <div class="card-body">
                 <div class="row " style="">
                    <div class="col-md-4">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    ...
                    <td class="">
                        <a href="{{route('admin.online_course.edit', $record->id)}}" title="{!! trans('base.edit') !!}" class="success"><i class="icon-pencil"></i></a>
