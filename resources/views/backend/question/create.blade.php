                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group row" data-field="images">
                                        ...
                                        <div class="col-md-10 div-image">
                                            <input type="hidden" class="image_data" name="image" value="{!!old('image')!!}" required=""/>
                                            <input type="file" id="image" multiple="" onclick="openKCFinder(this)" data-value="{!!old('image')!!}" class="file-input-overwrite" data-field="image">
